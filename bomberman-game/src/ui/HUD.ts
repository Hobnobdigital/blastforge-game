...
import { ExtendedGameState, GamePhase } from '@core/ExtendedTypes';

export class HUD {
  private container: HTMLElement;
  private gameInfo: HTMLElement;
  private levelInfo: HTMLElement | null = null;
  private timerInfo: HTMLElement | null = null;
  ...
  update(state: GameState, extendedState?: ExtendedGameState): void {
  ...
  private getElapsedTime(state: ExtendedGameState): number {
