...
export class MenuManager {
  ...
  private _currentScreen: MenuScreen = MenuScreen.MAIN;
  private onStartGame: (levelId: number) => void;
  ...
  showScreen(screen: MenuScreen): void {
  ...
  showGameOver(victory: boolean, stats?: { time: number; bombs: number; powerUps: number }): void {
    this.container.innerHTML = '';
    this.container.className = 'game-menus active';
  ...
  private bindButton(parent: HTMLElement, selector: string, callback: () => void): void {
  ...
  private bindToggle(parent: HTMLElement, selector: string, callback: () => void): void {
