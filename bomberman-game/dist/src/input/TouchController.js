...
export class TouchController {
     ...
     */
    createButton(id, label, className) {
    ...
    updateButtonPositions() {
        ...
        if (bomb)
            this.buttons.set('bomb', bomb);
        if (prime)
            this.buttons.set('prime', prime);
        if (rush)
            this.buttons.set('rush', rush);
        if (detonate)
            this.buttons.set('detonate', detonate);
    }
    /**
     ...
     */
    setButtonState(buttonId, pressed) {
        switch (buttonId) {
            case 'bomb':
     ...
     */
    updateButtonVisual(buttonId, pressed) {
